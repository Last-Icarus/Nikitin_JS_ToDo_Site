    ...
    if (list != undefined) {
        ...
        <>
            <Col span={8} style={{margin: '0 auto'}}>
                ...
                <Pagination size="default" locale={{items_per_page: "элементов на страницу"}} showSizeChanger showQuickJumper defaultCurrent={currentPage} defaultPageSize={perPage} total={list.length} onChange={handlerUpdatePages} style={{paddingBottom: 16}} />
            </Col>
        </>
        );
    }
